...
private var visualizationLifetime: TimeInterval {
    return Defaults.imessage.double(forKey: DefaultsKeys.eclipsingDebugVisualizationFadeOutDelay)
}

private var visualizationFadeOutDuration: TimeInterval {
    return Defaults.imessage.double(forKey: DefaultsKeys.eclipsingDebugVisualizationFadeOutDuration)
}
