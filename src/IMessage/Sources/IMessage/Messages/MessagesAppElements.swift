...
final class MessagesAppElements {
    ...
    init(runningApp: NSRunningApplication, openDeepLink: @escaping (URL) throws -> Void) {
    ...
    private func dismissAnyPresentedSheet() throws {
        ...
        // TODO: reason. eg this code path can repeatedly fail (such as after being automatically launched by imessage) until the user clicks on the app, which then actually causes the
