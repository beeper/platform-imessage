...
extension Mapper {
    ...
    func assignReactions(to message: inout [String: Any], filterIndex: Int?) {
    ...
    private func mapReactionAction(
        assocMsgType: String,
        message inputMessage: [String: Any],
        summaryInfo: [String: Any],
        isSMS: Bool
    ) -> [String: Any] {
    ...
    private func senderID(for row: [String: Any]) -> String {
